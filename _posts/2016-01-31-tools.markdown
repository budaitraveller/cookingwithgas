...
[Need to add info UP FRONT on how long it takes to download the testnet, and how log it takes to mine - time estimates.]

[There is a separate keystore for tesnet, check for that throughout]

[Joel tested with: instance: Geth/v1.4.7-stable-667a386d/darwin/go1.6.2]

[Might consider adding some loadScript commands: https://github.com/ethereum/go-ethereum/wiki/Managing-your-accounts]

[Rich tested with:

Richards-MacBook-Pro-2:~ rsb$ geth version
Geth
Version: 1.3.6
