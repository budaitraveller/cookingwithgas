...
[Need to add to the top sidebar - where to get help - where to report github issues for the post]
...
At the time of this writing, the state of ethereum smart contract development tools and documentation was: sub-optimal.  A beginner could spend many days banging their head against documentation and tools so buggy as to be barely functional in combination.  

In developing this article, and by fixing issues that you report, we hope that together we might save a few bothans, many of whom have already died to bring you this information.
...
When you have completed this tutorial, you will have a reliable set of tools that a beginning smart contract developer can use to develop ethereum smart contracts.
...
get geth here: https://www.ethereum.org/cli
